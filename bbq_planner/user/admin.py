...
class UserProfileAdmin(admin.ModelAdmin):
    model = UserProfile
    list_display = ['id', 'username', 'first_name', 'last_name', 'email', 'city', 'phone']
    search_fields = ['user_auth__username', 'user_auth__first_name', 'user_auth__last_name', 'user_auth__email', 'city', 'phone']
